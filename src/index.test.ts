import {
  ...
  GetDateArrayPropOrDefaultFunction,
  GetDateArrayPropOrThrow,
...
describe('strings', () => {
  test('PropOrDefaultFunction', () => {
    expect(
      GetStringPropOrDefaultFunction({ A: 'abc' }, 'A', () => null)
    ).toEqual('abc');
    expect(GetStringPropOrDefaultFunction({ A: 123 }, 'A', () => null)).toEqual(
      '123'
    );
...
describe('numbers', () => {
  test('PropOrDefaultFunction', () => {
    expect(GetNumberPropOrDefaultFunction({ A: 123 }, 'A', () => null)).toEqual(
      123
    );
    expect(
      GetNumberPropOrDefaultFunction({ A: '123' }, 'A', () => null)
    ).toEqual(123);
...
describe('dates', () => {
  const date = new Date();
  test('PropOrDefaultFunction', () => {
    expect(GetDatePropOrDefaultFunction({ A: date }, 'A', () => null)).toEqual(
      date
    );
    expect(GetDatePropOrDefaultFunction({ A: 1234 }, 'A', () => null)).toEqual(
      new Date(1234 * 1000)
    );
    expect(
      GetDatePropOrDefaultFunction({ A: '2023-01-01' }, 'A', () => null)
  ...
  test('PropOrDefault', () => {
    ...
    expect(GetDatePropOrDefault({ A: 1234 }, 'A', null)).toEqual(
      new Date(1234 * 1000)
    );
    expect(GetDatePropOrDefault({ A: '2023-01-01' }, 'A', null)).toEqual(
      new Date('2023-01-01')
    );
  ...
  test('PropOrThrow', () => {
    ...
    expect(GetDatePropOrThrow({ A: '2023-01-01' }, 'A')).toEqual(
      new Date('2023-01-01')
    );
...
describe('string array', () => {
  test('PropOrDefaultFunction', () => {
    expect(
      GetStringArrayPropOrDefaultFunction({ A: ['abc'] }, 'A', () => null)
    ).toEqual(['abc']);
    expect(
      GetStringArrayPropOrDefaultFunction({ A: [123] }, 'A', () => null)
    ).toEqual(['123']);
    expect(GetStringArrayPropOrDefaultFunction({}, 'A', () => null)).toBeNull();
  });
  test('PropOrDefault', () => {
    expect(GetStringArrayPropOrDefault({ A: ['abc'] }, 'A', null)).toEqual([
      'abc',
    ]);
    expect(GetStringArrayPropOrDefault({ A: [123] }, 'A', null)).toEqual([
      '123',
    ]);
...
describe('date array', () => {
  ...
  test('PropOrDefaultFunction', () => {
    expect(
      GetDateArrayPropOrDefaultFunction({ A: [date] }, 'A', () => null)
    ).toEqual([date]);
    expect(
      GetDateArrayPropOrDefaultFunction({ A: [1234] }, 'A', () => null)
    ).toEqual([new Date(1234 * 1000)]);
    expect(
      GetDateArrayPropOrDefaultFunction({ A: ['2023-01-01'] }, 'A', () => null)
    ).toEqual([new Date('2023-01-01')]);
    expect(GetDateArrayPropOrDefaultFunction({}, 'A', () => null)).toBeNull();
  });
  test('PropOrDefault', () => {
    expect(GetDateArrayPropOrDefault({ A: [date] }, 'A', null)).toEqual([date]);
    expect(GetDateArrayPropOrDefault({ A: [1234] }, 'A', null)).toEqual([
      new Date(1234 * 1000),
    ]);
    expect(GetDateArrayPropOrDefault({ A: ['2023-01-01'] }, 'A', null)).toEqual(
      [new Date('2023-01-01')]
    );
  ...
  test('PropOrThrow', () => {
    ...
    expect(GetDateArrayPropOrThrow({ A: [1234] }, 'A')).toEqual([
      new Date(1234 * 1000),
    ]);
    expect(GetDateArrayPropOrThrow({ A: ['2023-01-01'] }, 'A')).toEqual([
      new Date('2023-01-01'),
    ]);
...
describe('number array', () => {
  test('PropOrDefaultFunction', () => {
    expect(
      GetNumberArrayPropOrDefaultFunction({ A: [1, 2, 3] }, 'A', () => null)
    ).toEqual([1, 2, 3]);
    expect(
      GetNumberArrayPropOrDefaultFunction({ A: ['1', '2'] }, 'A', () => null)
    ).toEqual([1, 2]);
    expect(GetNumberArrayPropOrDefaultFunction({}, 'A', () => null)).toBeNull();
  });
  test('PropOrDefault', () => {
    expect(GetNumberArrayPropOrDefault({ A: [1, 2] }, 'A', null)).toEqual([
      1, 2,
    ]);
    expect(GetNumberArrayPropOrDefault({ A: ['3', '4'] }, 'A', null)).toEqual([
      3, 4,
    ]);
...
describe('boolean array', () => {
  test('PropOrDefaultFunction', () => {
    ...
    expect(
      GetBooleanArrayPropOrDefaultFunction({}, 'A', () => null)
    ).toBeNull();
  });
  test('PropOrDefault', () => {
    expect(GetBooleanArrayPropOrDefault({ A: [true] }, 'A', null)).toEqual([
      true,
    ]);
...
describe('bigint array', () => {
  test('PropOrDefaultFunction', () => {
    expect(
      GetBigIntArrayPropOrDefaultFunction({ A: [1n, 2n] }, 'A', () => null)
    ).toEqual([1n, 2n]);
    expect(
      GetBigIntArrayPropOrDefaultFunction({ A: [1, '2'] }, 'A', () => null)
    ).toEqual([1n, 2n]);
...
describe('object', () => {
  test('PropOrThrow', () => {
    expect(
      GetObjectPropOrThrow<TestObject | null>({ A: { A: 'abc' } }, 'A')
    ).toEqual({ A: 'abc' });
    expect(() => GetObjectPropOrThrow<TestObject | null>(null, 'A')).toThrow();
  });
  test('FunctionPropOrThrow', () => {
    expect(
      GetObjectFunctionPropOrThrow<TestObject | null>(
        { A: { A: 'abc' } },
        'A',
        (e) => new TestObject(e)
      )
  ...
  test('PropOrDefault', () => {
    expect(
      GetObjectPropOrDefault<TestObject | null>({ A: { A: 'abc' } }, 'A', null)
    ).toEqual({ A: 'abc' });
    expect(
      GetObjectPropOrDefault<TestObject | null>(null, 'A', null)
    ).toBeNull();
  });
  test('FunctionPropOrDefault', () => {
    expect(
      GetObjectFunctionPropOrDefault<TestObject | null>(
        { A: { A: 'abc' } },
        'A',
        (e) => new TestObject(e),
        null
  ...
  test('PropOrDefaultFunction', () => {
    expect(
      GetObjectPropOrDefaultFunction<TestObject | null>(
        { A: { A: 'abc' } },
        'A',
        (e) => new TestObject(e),
        () => null
...
describe('object array', () => {
  test('PropOrThrow', () => {
    expect(
      GetObjectArrayPropOrThrow<TestObject, TestObject[] | null>(
        { A: [{ A: 'abc' }] },
        'A'
      )
    ).toEqual([{ A: 'abc' }]);
    expect(() =>
      GetObjectArrayPropOrThrow<TestObject, TestObject[] | null>(null, 'A')
    ).toThrow();
  });
  test('FunctionPropOrThrow', () => {
    expect(
      GetObjectArrayFunctionPropOrThrow<TestObject, TestObject[] | null>(
        { A: [{ A: 'abc' }] },
        'A',
        (e) => new TestObject(e)
      )
  ...
  test('PropOrDefault', () => {
    expect(
      GetObjectArrayPropOrDefault<TestObject, TestObject[] | null>(
        { A: [{ A: 'abc' }] },
        'A',
        null
      )
  ...
  test('FunctionPropOrDefault', () => {
    expect(
      GetObjectArrayFunctionPropOrDefault<TestObject, TestObject[] | null>(
        { A: [{ A: 'abc' }] },
        'A',
        (e) => new TestObject(e),
        null
  ...
  test('PropOrDefaultFunction', () => {
    expect(
      GetObjectArrayPropOrDefaultFunction<TestObject, TestObject[] | null>(
        { A: [{ A: 'abc' }] },
        'A',
        (e) => new TestObject(e),
        () => null
...
describe('boolean', () => {
  test('PropOrThrow', () => {
    ...
    expect(
      GetBooleanPropOrThrow({ A: 'yes' }, 'A', (v: unknown) => v === 'yes')
    ).toEqual(true);
  ...
  test('FunctionPropOrDefault', () => {
    ...
    expect(
      GetBooleanFunctionPropOrDefault({ A: 0 }, 'A', (v: unknown) => !!v, true)
    ).toEqual(false);
    expect(
      GetBooleanFunctionPropOrDefault({}, 'A', (v: unknown) => !!v, false)
    ).toEqual(false);
  });
});
...
describe('map', () => {
  ...
  test('PropOrDefault', () => {
    ...
    expect(GetMapPropOrDefault({ A: { key: 'value' } }, 'A', null)).toEqual(
      map
    );
  ...
  test('PropOrDefaultFunction', () => {
    const map = new Map([['key', 'value']]);
    expect(GetMapPropOrDefaultFunction({ A: map }, 'A', () => null)).toEqual(
      map
    );
    expect(
      GetMapPropOrDefaultFunction({ A: { key: 'value' } }, 'A', () => null)
    ).toEqual(map);
...
describe('bigint', () => {
  ...
  test('PropOrDefaultFunction', () => {
    expect(
      GetBigIntPropOrDefaultFunction({ A: 123n }, 'A', () => null)
    ).toEqual(123n);
    expect(GetBigIntPropOrDefaultFunction({ A: 123 }, 'A', () => null)).toEqual(
      123n
    );
    expect(
      GetBigIntPropOrDefaultFunction({ A: '123' }, 'A', () => null)
    ).toEqual(123n);
...
describe('object allow null', () => {
  test('PropOrThrow', () => {
    expect(
      GetObjectPropOrThrowAllowNull<TestObject | null>({ A: { A: 'abc' } }, 'A')
    ).toEqual({ A: 'abc' });
    expect(() =>
      GetObjectPropOrThrowAllowNull<TestObject | null>(null, 'A')
    ).toThrow();
  });
  test('FunctionPropOrThrow', () => {
    expect(
      GetObjectFunctionPropOrThrowAllowNull<TestObject | null>(
        { A: { A: 'abc' } },
        'A',
        (e) => new TestObject(e as Partial<Record<keyof TestObject, unknown>>)
      )
    ).toEqual({ A: 'abc' });
    expect(() =>
      GetObjectFunctionPropOrThrowAllowNull<TestObject | null>(
  ...
  test('PropOrDefault', () => {
    expect(
      GetObjectPropOrDefaultAllowNull<TestObject | null>(
        { A: { A: 'abc' } },
        'A',
        null
      )
    ...
    expect(
      GetObjectPropOrDefaultAllowNull<TestObject | null>(null, 'A', null)
    ).toBeNull();
  });
  test('FunctionPropOrDefault', () => {
    expect(
      GetObjectFunctionPropOrDefaultAllowNull<TestObject | null>(
        { A: { A: 'abc' } },
        'A',
        (e) => new TestObject(e as Partial<Record<keyof TestObject, unknown>>),
        null
  ...
  test('PropOrDefaultFunction', () => {
    expect(
      GetObjectPropOrDefaultFunctionAllowNull<TestObject | null>(
        { A: { A: 'abc' } },
        'A',
        (e: Partial<Record<keyof TestObject, unknown>> | null) =>
          new TestObject(e as Partial<Record<keyof TestObject, unknown>>),
        () => null
      )
    ).toEqual({ A: 'abc' });
    expect(
...
describe('regexp', () => {
  test('PropOrDefaultFunction', () => {
    expect(
      GetRegExpPropOrDefaultFunction({ A: /abc/ }, 'A', () => null)
    ).toEqual(/abc/);
    expect(
      GetRegExpPropOrDefaultFunction({ A: 'abc' }, 'A', () => null)
    ).toEqual(/abc/);
...
describe('regexp array', () => {
  test('PropOrDefaultFunction', () => {
    expect(
      GetRegExpArrayPropOrDefaultFunction({ A: [/abc/] }, 'A', () => null)
    ).toEqual([/abc/]);
    expect(
      GetRegExpArrayPropOrDefaultFunction({ A: ['abc'] }, 'A', () => null)
    ).toEqual([/abc/]);
  ...
  test('PropOrDefault', () => {
    expect(GetRegExpArrayPropOrDefault({ A: [/abc/] }, 'A', null)).toEqual([
      /abc/,
    ]);
    expect(GetRegExpArrayPropOrDefault({ A: ['abc'] }, 'A', null)).toEqual([
      /abc/,
...
describe('typed helpers', () => {
  ...
  test('typed throw conversions', () => {
    expect(
      GetTypedStringPropOrThrow<TypedPropsExample>(typedProps, 'name')
    ).toBe('123');
    expect(
      GetTypedNumberPropOrThrow<TypedPropsExample>(typedProps, 'count')
    ).toBe(42);
    expect(
      GetTypedDatePropOrThrow<TypedPropsExample>(typedProps, 'started')
    ).toEqual(new Date('2022-12-31'));
    expect(
      GetTypedStringArrayPropOrThrow<TypedPropsExample>(typedProps, 'labels')
    ).toEqual(['1', 'two']);
    expect(
      GetTypedDateArrayPropOrThrow<TypedPropsExample>(typedProps, 'timestamps')
    ).toEqual([new Date('2023-01-01'), new Date(5 * 1000)]);
    expect(
      GetTypedBooleanPropOrThrow<TypedPropsExample>(
        typedProps,
        'active',
        (v: unknown) => v === 'Y'
      )
    ...
    expect(
      GetTypedNumberArrayPropOrThrow<TypedPropsExample>(typedProps, 'numbers')
    ).toEqual([1, 2]);
    expect(
      GetTypedBooleanArrayPropOrThrow<TypedPropsExample>(typedProps, 'booleans')
    ).toEqual([true, false]);
    expect(
      GetTypedBigIntArrayPropOrThrow<TypedPropsExample>(typedProps, 'bigints')
    ).toEqual([1n, 2n]);
    expect(
      GetTypedRegExpPropOrThrow<TypedPropsExample>(typedProps, 'regex')
    ).toEqual(/abc/);
    expect(
      GetTypedRegExpArrayPropOrThrow<TypedPropsExample>(typedProps, 'regexes')
    ).toEqual([/abc/, /def/]);
  });
  ...
  test('typed defaults', () => {
    ...
    expect(
      GetTypedStringPropOrDefault<TypedPropsExample>(emptyProps, 'name', null)
    ).toBeNull();
    expect(
      GetTypedNumberPropOrDefault<TypedPropsExample>(emptyProps, 'count', null)
    ).toBeNull();
    expect(
      GetTypedDatePropOrDefault<TypedPropsExample>(emptyProps, 'started', null)
    ).toBeNull();
    expect(
      GetTypedStringArrayPropOrDefault<TypedPropsExample>(
        emptyProps,
        'labels',
        null
      )
    ...
    expect(
      GetTypedDateArrayPropOrDefault<TypedPropsExample>(
        emptyProps,
        'timestamps',
        null
      )
    ...
    expect(
      GetTypedBooleanPropOrDefault<TypedPropsExample>(
        emptyProps,
        'active',
        false
      )
    ...
    expect(
      GetTypedNumberArrayPropOrDefault<TypedPropsExample>(
        emptyProps,
        'numbers',
        null
      )
    ...
    expect(
      GetTypedBooleanArrayPropOrDefault<TypedPropsExample>(
        emptyProps,
        'booleans',
        null
      )
    ...
    expect(
      GetTypedBigIntArrayPropOrDefault<TypedPropsExample>(
        emptyProps,
        'bigints',
        null
      )
    ...
    expect(
      GetTypedRegExpPropOrDefault<TypedPropsExample>(emptyProps, 'regex', null)
    ).toBeNull();
    expect(
      GetTypedRegExpArrayPropOrDefault<TypedPropsExample>(
        emptyProps,
        'regexes',
        null
      )
